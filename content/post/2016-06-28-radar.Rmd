...
image_preview: "/radar-perfect.png"
---
...
![Mango Solutions Data Science Radar](/img/radar.png)
...
random_data <- read_csv(file.path(here(), "data", "radar-random.csv"))
...
```{r radar-systematic}
systematic_data <- read_csv(file.path(here(), "data", "radar-systematic.csv"))
systematic <-
  systematic_data %>%
...
```{r radar-perfect}
perfect_data <- read_csv(file.path(here(), "data", "radar-perfect.csv"))
systematic <-
  perfect_data %>%
  select(-(starts_with("q"))) %>%
  mutate(statement = 1:n() - 1) %>%
...
```{r radar-diff}
penalty <-  read_csv(file.path(here(), "data", "radar-penalties.csv"))
penaltygraph <-
  penalty %>%
  select(-1:-24) %>%
...
![Mango Solutions Data Science Radar: worst score](/img/radar-worst.png)
...
questions <- read_csv(file.path(here(), "data", "radar-questions.csv"))
...
# # posterity
# results %>% write_csv(file.path(here(), "data", "radar-results.csv"))
results <- read_csv(file.path(here(), "data", "radar-results.csv"))
...
![Mango Solutions Data Science Radar: perfect score](/img/radar-perfect.png)
