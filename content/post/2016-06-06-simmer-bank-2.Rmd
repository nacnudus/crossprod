...
In my [previous post](/post/2016-05-11-simmer-bank-1), I ported [Part
I](https://pythonhosted.org/SimPy/Tutorials/TheBank.html) of `SimPy`'s flagship
tutorial, *The Bank*, to `simmer`.  This post does the same for [Part
II](https://pythonhosted.org/SimPy/Tutorials/TheBank2.html), which introduces
tricky concepts for tricky customers.
